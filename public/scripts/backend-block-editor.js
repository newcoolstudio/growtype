...
/***/ "./resources/scripts/editor/gutenberg/backend/main.js":
/*!************************************************************!*\
  !*** ./resources/scripts/editor/gutenberg/backend/main.js ***!
  \************************************************************/
...
/* harmony import */ var _settings_max_width__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./settings/max-width */ "./resources/scripts/editor/gutenberg/backend/settings/max-width.js");
/* harmony import */ var _settings_button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./settings/button */ "./resources/scripts/editor/gutenberg/backend/settings/button.js");

 // import "./settings/background";

/***/ }),

/***/ "./resources/scripts/editor/gutenberg/backend/settings/button.js":
/*!***********************************************************************!*\
  !*** ./resources/scripts/editor/gutenberg/backend/settings/button.js ***!
  \***********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var _wp$components = wp.components,
    ...
    ToggleControl = _wp$components.ToggleControl; // Attributes.

addFilter('blocks.registerBlockType', 'jb/core-button', function (props, name) {
  if ('core/button' !== name) {
    return props;
  }

  var attributes = _objectSpread(_objectSpread({}, props.attributes), {}, {
    target: {
      type: 'string',
      "default": '',
      source: 'attribute',
...
var withInspectorControls = createHigherOrderComponent(function (BlockEdit) {
  return function (props) {
    if ('core/button' !== props.name) {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(BlockEdit, _objectSpread({}, props));
    }

    var attributes = props.attributes,
        setAttributes = props.setAttributes;
    var checked = '_blank' === attributes.target;
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Fragment, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(BlockEdit, _objectSpread({}, props)), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(InspectorControls, {
...
addFilter('editor.BlockEdit', 'jb/core-button', withInspectorControls); // Save.

addFilter('blocks.getSaveElement', 'jb/core-button', function (element, block, attributes) {
...
/***/ "./resources/scripts/editor/gutenberg/backend/settings/max-width.js":
/*!**************************************************************************!*\
  !*** ./resources/scripts/editor/gutenberg/backend/settings/max-width.js ***!
  \**************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var enableMaxWidthControlOnBlocks = ['core/paragraph', 'core/heading', 'core/image', 'core/group'];
/**
 * Create attributes
 */
...
var withMaxWidthControl = createHigherOrderComponent(function (BlockEdit) {
  return function (props) {
...
var withToolbarButtonProp = createHigherOrderComponent(function (BlockListBlock) {
  return function (props) {
    ...
    if (!enableMaxWidthControlOnBlocks.includes(props.name)) {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(BlockListBlock, _objectSpread({}, props));
    }
    ...
    if (Object.entries(divStyle).length !== 0) {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
        style: divStyle,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(BlockListBlock, _objectSpread({}, props))
      });
    } else {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(BlockListBlock, _objectSpread({}, props));
    }
...
"use strict";
/*!***************************************************!*\
  !*** ./resources/scripts/backend-block-editor.js ***!
  \***************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _editor_gutenberg_backend_main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./editor/gutenberg/backend/main */ "./resources/scripts/editor/gutenberg/backend/main.js");
