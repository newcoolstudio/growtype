<tr>
    ...
    <td class="file_url"><input type="text" class="input_text" placeholder="<?php esc_attr_e( 'http://', 'growtype' ); ?>" name="_wc_shipping_file_urls[]" value="<?php echo esc_attr( $file['file'] ); ?>" /></td>
