...
//        dd(get_template_public_path());
        wp_enqueue_style('growtype/buddypress/buddypress-styles', get_template_public_path() . '/styles/plugins/buddypress/buddypress.css', false, null);

        wp_enqueue_script('bp-like', get_template_public_path() . '/scripts/plugins/buddypress/like.js', '', '', true);
        wp_enqueue_script('bp-general', get_template_public_path() . '/scripts/plugins/buddypress/general.js', ['jquery','growtype/flexmenu'], '', true);
