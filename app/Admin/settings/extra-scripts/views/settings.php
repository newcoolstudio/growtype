                        ...
                        <div class="inside">
                            <form action="options-general.php?page=<?php echo $this->plugin->name; ?>" method="post">
                                ...
                                if (is_multisite() && get_current_blog_id() === 1) { ?>
                                    ...
                                    <p>
                                        <label for="ihaf_insert_multisite_header"><strong><?php esc_html_e('Scripts in Header', 'insert-headers-and-footers'); ?></strong></label>
                                        <textarea name="ihaf_insert_multisite_header" id="ihaf_insert_multisite_header" class="widefat" rows="8" style="font-family:Courier New;"><?php echo $this->settings['ihaf_insert_multisite_header']; ?></textarea>
                                        <?php
                                        printf(
                                    ...
                                    <?php if ($this->body_open_supported) : ?>
                                        <p>
                                            <label for="ihaf_insert_multisite_body"><strong><?php esc_html_e('Scripts in Body', 'insert-headers-and-footers'); ?></strong></label>
                                            <textarea name="ihaf_insert_multisite_body" id="ihaf_insert_multisite_body" class="widefat" rows="8" style="font-family:Courier New;"><?php echo $this->settings['ihaf_insert_multisite_body']; ?></textarea>
                                            <?php
                                            printf(
                                            /* translators: %s: The `<head>` tag */
                                    ...
                                    <?php endif; ?>
                                    <p>
                                        <label for="ihaf_insert_multisite_footer"><strong><?php esc_html_e('Scripts in Footer', 'insert-headers-and-footers'); ?></strong></label>
                                        <textarea name="ihaf_insert_multisite_footer" id="ihaf_insert_multisite_footer" class="widefat" rows="8" style="font-family:Courier New;"><?php echo $this->settings['ihaf_insert_multisite_footer']; ?></textarea>
                                        <?php
                                        printf(
