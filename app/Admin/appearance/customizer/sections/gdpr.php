...
class Gdpr_Customizer_Register
{
    /**
     * Constructor.
     */
    ...
    function customizer_init($wp_customize)
    {
        ...
        $wp_customize->add_setting('growtype_gdpr_alert_content',
            array (
                ...
                'sanitize_callback' => array ($this, 'growtype_gdpr_alert_content_translation')
            )
        );
...
//                'toolbar2' => 'formatselect',
        ...
        $wp_customize->add_setting("growtype_gdpr_alert_agree_btn_text", array (
            "default" => "",
            'sanitize_callback' => array ($this, 'growtype_gdpr_alert_agree_btn_text_translation')
        ));
