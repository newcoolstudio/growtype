...
if (class_exists('WP_Customize_Control')) {
    ...
    {
        protected function get_skyrocket_assets_url()
        {
            return dirname(get_template_directory_uri()) . '/app/Admin/appearance/customizer/assets/';
        }
    }
    ...
    class Skyrocket_Image_Checkbox_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        {
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_assets_url() . 'css/customizer.css', array (), '1.0', 'all');
        }
    ...
    class Skyrocket_Single_Accordion_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        public function enqueue()
        {
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_skyrocket_assets_url() . 'js/customizer-control.js', array ('jquery'), '1.0', true);
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_assets_url() . 'css/customizer.css', array (), '1.0', 'all');
        }
    ...
    class Skyrocket_Slider_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        public function enqueue()
        {
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_skyrocket_assets_url() . 'js/customizer-control.js', array ('jquery', 'jquery-ui-core'), '1.0', true);
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_assets_url() . 'css/customizer.css', array (), '1.0', 'all');
        }
    ...
    class Skyrocket_Dropdown_Select2_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        public function enqueue()
        {
            wp_enqueue_script('skyrocket-select2-js', $this->get_skyrocket_assets_url() . 'js/select2.full.min.js', array ('jquery'), '4.0.13', true);
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_skyrocket_assets_url() . 'js/customizer-control.js', array ('skyrocket-select2-js'), '1.0', true);
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_assets_url() . 'css/customizer.css', array (), '1.1', 'all');
            wp_enqueue_style('skyrocket-select2-css', $this->get_skyrocket_assets_url() . 'css/select2.min.css', array (), '4.0.13', 'all');
        }
    ...
    class Skyrocket_Google_Font_Select_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        public function skyrocket_getGoogleFonts($count = 30)
        {
            ...
            $fontFile = $this->get_skyrocket_assets_url() . 'fonts/google-fonts-alphabetical.json';

//            if ($this->fontOrderBy === 'popular') {
//                $fontFile = $this->get_skyrocket_assets_url() . 'fonts/google-fonts-popularity.json';
//            }

            $request = wp_remote_get($fontFile, array (
                'timeout' => 20,
                'sslverify' => false
            ));
    ...
    class Skyrocket_Customize_Alpha_Color_Control extends Skyrocket_Custom_Control
    {
        ...
        public function enqueue()
        {
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_skyrocket_assets_url() . 'js/customizer-control.js', array ('jquery', 'wp-color-picker'), '1.0', true);
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_assets_url() . 'css/customizer.css', array ('wp-color-picker'), '1.0', 'all');
        }
    ...
    class Skyrocket_Alpha_Color_Control extends Skyrocket_Custom_Control
    {
        ...
        {
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_assets_url() . 'css/customizer.css', array (), '1.0', 'all');
            wp_enqueue_script('wp-color-picker-alpha', $this->get_skyrocket_assets_url() . 'js/wp-color-picker-alpha-min.js', array ('wp-color-picker'), '1.0', true);
    ...
    class Skyrocket_Pill_Checkbox_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        public function enqueue()
        {
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_skyrocket_assets_url() . 'js/customizer-control.js', array ('jquery', 'jquery-ui-core'), '1.1', true);
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_assets_url() . 'css/customizer.css', array (), '1.0', 'all');
        }
