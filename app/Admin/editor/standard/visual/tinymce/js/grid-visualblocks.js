(function() {
	...
	tinymce.create('tinymce.plugins.visualblocks', {
		init : function(editor, url) {
			...
			editor.settings.visualblocks_default_state = true;
			...
			editor.addCommand('mceVisualBlocks', function() {
				...
				if(!cssId) {
					...
					linkElm = dom.create('link', {
						id: cssId,
						rel: 'stylesheet',
						href: '/app/themes/growtype/app/Admin/editor/standard/visual/tinymce/css/blocks.css'
					});
			...
			editor.addButton('visualblocks', {
				...
				icon : 'marquee feather-icon icon-box',
				cmd: 'mceVisualBlocks',
