...
function check_and_apply_custom_page_redirect()
{
    ...
    if ($login_redirect_enabled) {
        ...
        $page_available_when_not_logged_in = page_is_among_enabled_pages($pages_available_when_not_logged_in);
        ...
        if (!is_user_logged_in()) {
            if (!$page_available_when_not_logged_in) {
            ...
            if (class_exists('woocommerce')) {
                ...
                if (!$user_has_bought_required_products) {
                    if (!empty($redirect_page) && !$page_available_when_not_logged_in && $redirect_page !== get_permalink()) {
                    ...
                    } elseif (!$page_available_when_not_logged_in || $redirect_page === get_permalink()) {
