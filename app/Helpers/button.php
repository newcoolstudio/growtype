 ...
 * Primary button text color
 */
if (!function_exists('growtype_primary_button_text_color_active')) {
    function growtype_primary_button_text_color_active()
    {
        $colors_scheme = growtype_get_theme_current_colors_scheme();
        return get_theme_mod('primary_button_text_color_active', $colors_scheme['primary_button_text_color_active']);
    }
}
