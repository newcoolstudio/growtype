...
?>
<li class="wc_payment_method payment_method_<?php echo esc_attr($gateway->id); ?>" {{isset($gateway->settings['visible_in_frontend']) && $gateway->settings['visible_in_frontend'] === 'no' ? 'hidden' : ''}}>
